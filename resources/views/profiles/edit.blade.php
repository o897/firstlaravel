...
<div class="container">
    ...
    {{-- olf title is when you failed validation the returned data is the data you once set --}}
    {{-- We are dealing with current user profile so we have to get the user current profile's info --}}
                ...
                <div class="form-group row">
                    ...
                    {{-- Current user->get profile->get the url --}}
